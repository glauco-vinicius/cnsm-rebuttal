...
**Comments 6-9.** All incorporated: abstract distinguishes confirmed-TP from candidate-only categories; Section IV-A retitled to align with RQ1; "coverage" clarified as candidate-generation coverage, not recall; Section III-E clarifies pre-filter and manual estimates treat outside-scope findings identically.
